...
void loop() {
 ...
 if(digitalRead(buttonPin) == 0) digitalWrite(Buzzer,HIGH);
    ...
    if (Time >= 2.0)
    {
      ...
      if (count > 5) {
        ...
        */
        ...
        do {
          u8g2.setFont(u8g2_font_ncenB10_tr);
          u8g2.drawStr(0,24,"Decrease Honk Time");
        } while ( u8g2.nextPage() );
        delay(500);
        j=millis();
        i=1;
    ...
    if (a > 10) {
      ...
      delay(200);
        ...
        */ 
          ...
          do {
            u8g2.setFont(u8g2_font_ncenB10_tr);
            u8g2.drawStr(0,24,"STOP Honking");
          } while ( u8g2.nextPage() );
          delay(500);
         // OLED.display();
          j=millis();
...
void fine(){
  ...
  do {
    u8g2.setFont(u8g2_font_ncenB10_tr);
    u8g2.drawStr(0,24,"You are fined");
  } while ( u8g2.nextPage() );
          delay(500);
          j=millis();
          i=1;
